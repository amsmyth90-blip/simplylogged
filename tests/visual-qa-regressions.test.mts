...
test("calendar, sign-out, and bootstrap retain the visual QA fixes", async () => {
  const [calendar, calendarModel, signOutPanel, signOutRoute, bootstrap, migration] = await Promise.all([
