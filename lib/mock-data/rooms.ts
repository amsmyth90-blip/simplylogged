import type { AreaIcon, AreaStatus } from "@/lib/mock-data/estate";
...
type RoomDefinition = Omit<RoomDetail, "stats" | "tasks" | "documents" | "activity">;

function emptyRoom(definition: RoomDefinition): RoomDetail {
  return {
    ...definition,
