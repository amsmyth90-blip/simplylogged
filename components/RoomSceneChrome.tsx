...
export const roomMarkerHaloClass =
  "absolute inset-[-5px] animate-pulse rounded-full border border-white/55 motion-reduce:animate-none";

export const roomMarkerDotClass =
  "relative h-2 w-2 rounded-full bg-[#6f8b62] shadow-[0_0_0_3px_rgba(255,255,255,0.72)]";
...
export function RoomHotspotMarker({
  ...
  return (
    <span className={`pointer-events-none absolute z-30 h-9 w-9 -translate-x-1/2 -translate-y-1/2 ${className}`}>
