  ...
  return (
    <main className="min-h-[100svh] bg-[#f5f1e8] px-4 pb-28 pt-[max(1rem,env(safe-area-inset-top))] text-[#20352a] sm:px-6">
      <div className="mx-auto max-w-5xl">
        <PageHeader eyebrow="Private smart labels" title="Physical Links" subtitle="Connect a QR code or NFC tag to an appliance or boiler without putting its private record ID on the label." backHref="/settings" action={<button type="button" onClick={() => setShowAssetForm((value) => !value)} className="inline-flex min-h-11 items-center gap-2 rounded-2xl bg-[#315443] px-4 text-sm font-semibold text-white"><UiIcon name="plus" className="h-4 w-4" />Add item</button>} />
