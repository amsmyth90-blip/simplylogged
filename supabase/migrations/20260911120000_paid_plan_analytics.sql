-- New subscription events use the three paid tiers; historical events are retained.
...
begin
  ...
  if input_event_name = 'subscription_started' and clean_properties->>'planTier' not in ('STARTER', 'PLUS', 'FAMILY') then raise exception 'Invalid plan tier'; end if;
