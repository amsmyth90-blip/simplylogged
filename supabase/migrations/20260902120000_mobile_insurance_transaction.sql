-- Save one revision-checked Office insurance change and linked document metadata atomically.
create or replace function public.apply_mobile_insurance_state(
...
from public, anon;
grant execute on function public.apply_mobile_insurance_state(timestamptz, jsonb, jsonb)
to authenticated;
