      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            "If you opt in to Product analytics, to understand setup, first useful actions, return use and broad subscription tier using a fixed event list. Analytics never includes your questions, document titles or contents, filenames, notes, contact details, policy numbers, Vault material or security audit contents.",
